// Prompts database matching data/prompts.ts
const prompts = [
  {
    ...
    image: "public/3d-glossy-black.webp",
  ...
  },
  {
    ...
    image: "public/3d-glossy-colored.webp",
    createdAt: "2026-06-06",
    prompt:
  ...
  },
  {
    ...
    image: "public/photo-enhancement.webp",
    createdAt: "2026-06-06",
    prompt:
  ...
  },
  {
    ...
    image: "public/3d-glossy-colored-2.webp",
    createdAt: "2026-06-06",
    prompt:
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  prompts.forEach((prompt) => {
    ...
    card.innerHTML = `
      <div class="card-image-container">
        <img src="${prompt.image}" alt="" class="card-image" loading="lazy">
      </div>
      <h2 class="card-title">${prompt.title}</h2>
      <button class="copy-button" data-id="${prompt.id}" aria-label="Copy prompt">
        ${CLIPBOARD_SVG}
    ...
    button.addEventListener("click", () => {
      copyToClipboard(prompt.prompt, button);
    });
  ...
  async function copyToClipboard(text, button) {
    ...
    if (success) {
      ...
      button.innerHTML = `${CHECK_SVG} <span class="button-text">Copied</span>`;
      showToast("Copied prompt");

      setTimeout(() => {
        button.innerHTML = `${CLIPBOARD_SVG} <span class="button-text">Copy prompt</span>`;
      }, 1800);
    } else {
